...
export declare const PageSize: {
	...
	A3Landscape: [number, number];
	A4Landscape: [number, number];
	A5Landscape: [number, number];
	B4Landscape: [number, number];
	B5Landscape: [number, number];
	LetterLandscape: [number, number];
	LegalLandscape: [number, number];
	LedgerLandscape: [number, number];
};
